...
export type CartIconProps = { widthIcon?: string, heightIcon?: string, activatedAnimation?: boolean }

const CartIcon: FC<CartIconProps> = ({ widthIcon, heightIcon, activatedAnimation = false }) => {
  return (
    <>
